...
public enum Category {
    ...
    INJECTION("A1 - Injection Flaws", new Integer(200)),
    AUTHENTICATION("A2 - Authentication Flaws", new Integer(300)),
    XSS("A3 - Cross-Site Scripting (XSS)", new Integer(400)),
    REQ_FORGERIES("Request Forgeries", new Integer(450)),
    ACCESS_CONTROL("A4 - Access Control Flaws", new Integer(500)),
    INSECURE_CONFIGURATION("A5 - Insecure Configuration", new Integer(600)),
    INSECURE_COMMUNICATION("A6 - Insecure Communication", new Integer(700)),
    INSECURE_STORAGE("A7 - Insecure Storage", new Integer(800)),
    REQUEST_FORGERIES("A8 - Request Forgeries", new Integer(900)),
    VULNERABLE_COMPONENTS("A9 - Vulnerable Components", new Integer(950)),
